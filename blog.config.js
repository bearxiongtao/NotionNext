...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Bear韬', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Bear韬的个人博客', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'http://43.156.0.125:3002/#/chat/1002', // 网站地址
